...
public class ColumnProperties {
    ...
    public String toString() {
        return "adapter" + mDragItemAdapter.getItemList().size();
    }
    ...
    public static class Builder {
        ...
        public com.emika.app.features.draglistview.ColumnProperties build() {
            return new com.emika.app.features.draglistview.ColumnProperties(mDragItemAdapter,
                    mLayoutManager,
                    mItemDecoration,
                    mHasFixedItemSize,
