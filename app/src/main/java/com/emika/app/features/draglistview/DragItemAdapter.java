...
package com.emika.app.features.draglistview;
...
public abstract class DragItemAdapter<T, VH extends com.emika.app.features.draglistview.DragItemAdapter.ViewHolder> extends RecyclerView.Adapter<VH> {
    private static final String TAG = "DragItemAdapter";
    ...
    protected ArrayList<Pair<Long, PayloadTask>> mItemList;
    ...
    public void setItemList(ArrayList<Pair<Long, PayloadTask>> itemList) {
        mItemList = itemList;
        notifyDataSetChanged();
    }

    public ArrayList<Pair<Long, PayloadTask>> getItemList() {
        return mItemList;
    }
    ...
    public Pair removeItem(int pos) {
        if (mItemList != null && mItemList.size() > pos && pos >= 0) {
            Pair item = mItemList.remove(pos);
