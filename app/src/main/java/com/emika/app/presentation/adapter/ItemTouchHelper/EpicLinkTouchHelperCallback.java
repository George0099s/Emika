...
public class EpicLinkTouchHelperCallback extends ItemTouchHelper.Callback {
    private final EpicLinksAdapter mAdapter;

    public EpicLinkTouchHelperCallback(EpicLinksAdapter adapter) {
        mAdapter = adapter;
    }
